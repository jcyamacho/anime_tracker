...
class _$GAiringScheduleInput extends GAiringScheduleInput {
  ...
  factory _$GAiringScheduleInput(
      ...
      (new GAiringScheduleInputBuilder()..update(updates)).build();
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc(0, airingAt.hashCode), episode.hashCode),
        timeUntilAiring.hashCode));
  }

  @override
  String toString() {
    return (newBuiltValueToStringHelper('GAiringScheduleInput')
...
class _$GAniChartHighlightInput extends GAniChartHighlightInput {
  ...
  factory _$GAniChartHighlightInput(
      ...
      (new GAniChartHighlightInputBuilder()..update(updates)).build();
  ...
  @override
  int get hashCode {
    return $jf($jc($jc(0, mediaId.hashCode), highlight.hashCode));
  }

  @override
  String toString() {
    return (newBuiltValueToStringHelper('GAniChartHighlightInput')
          ..add('mediaId', mediaId)
...
class GAniChartHighlightInputBuilder
  ...
  @override
  _$GAniChartHighlightInput build() {
    final _$result = _$v ??
...
class _$GCharacterNameInput extends GCharacterNameInput {
  ...
  factory _$GCharacterNameInput(
      ...
      (new GCharacterNameInputBuilder()..update(updates)).build();
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc(
                $jc($jc($jc(0, first.hashCode), middle.hashCode),
                    last.hashCode),
                native.hashCode),
            alternative.hashCode),
        alternativeSpoiler.hashCode));
  }

  @override
  String toString() {
    return (newBuiltValueToStringHelper('GCharacterNameInput')
          ..add('first', first)
          ..add('middle', middle)
          ..add('last', last)
          ..add('native', native)
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GCharacterNameInput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$GCountryCode extends GCountryCode {
  ...
  factory _$GCountryCode([void Function(GCountryCodeBuilder)? updates]) =>
      (new GCountryCodeBuilder()..update(updates)).build();

  _$GCountryCode._({required this.value}) : super._() {
    BuiltValueNullFieldError.checkNotNull(value, 'GCountryCode', 'value');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GCountryCode')..add('value', value))
        .toString();
  }
}
...
class GCountryCodeBuilder
  ...
  @override
  _$GCountryCode build() {
    final _$result = _$v ??
        new _$GCountryCode._(
            value: BuiltValueNullFieldError.checkNotNull(
                value, 'GCountryCode', 'value'));
    replace(_$result);
    return _$result;
  }
}
...
class _$GFuzzyDateInput extends GFuzzyDateInput {
  ...
  factory _$GFuzzyDateInput([void Function(GFuzzyDateInputBuilder)? updates]) =>
      (new GFuzzyDateInputBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GFuzzyDateInput')
          ..add('year', year)
          ..add('month', month)
          ..add('day', day))
        .toString();
...
class _$GFuzzyDateInt extends GFuzzyDateInt {
  ...
  factory _$GFuzzyDateInt([void Function(GFuzzyDateIntBuilder)? updates]) =>
      (new GFuzzyDateIntBuilder()..update(updates)).build();

  _$GFuzzyDateInt._({required this.value}) : super._() {
    BuiltValueNullFieldError.checkNotNull(value, 'GFuzzyDateInt', 'value');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GFuzzyDateInt')..add('value', value))
        .toString();
  }
}
...
class GFuzzyDateIntBuilder
  ...
  @override
  _$GFuzzyDateInt build() {
    final _$result = _$v ??
        new _$GFuzzyDateInt._(
            value: BuiltValueNullFieldError.checkNotNull(
                value, 'GFuzzyDateInt', 'value'));
    replace(_$result);
    return _$result;
  }
}
...
class _$GMediaExternalLinkInput extends GMediaExternalLinkInput {
  ...
  factory _$GMediaExternalLinkInput(
      ...
      (new GMediaExternalLinkInputBuilder()..update(updates)).build();

  _$GMediaExternalLinkInput._(
      {required this.id, required this.url, required this.site})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(id, 'GMediaExternalLinkInput', 'id');
    BuiltValueNullFieldError.checkNotNull(
        url, 'GMediaExternalLinkInput', 'url');
    BuiltValueNullFieldError.checkNotNull(
        site, 'GMediaExternalLinkInput', 'site');
  }
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc(0, id.hashCode), url.hashCode), site.hashCode));
  }

  @override
  String toString() {
    return (newBuiltValueToStringHelper('GMediaExternalLinkInput')
          ..add('id', id)
          ..add('url', url)
          ..add('site', site))
        .toString();
...
class GMediaExternalLinkInputBuilder
  ...
  @override
  _$GMediaExternalLinkInput build() {
    final _$result = _$v ??
        new _$GMediaExternalLinkInput._(
            id: BuiltValueNullFieldError.checkNotNull(
                id, 'GMediaExternalLinkInput', 'id'),
...
class _$GMediaListOptionsInput extends GMediaListOptionsInput {
  ...
  factory _$GMediaListOptionsInput(
      ...
      (new GMediaListOptionsInputBuilder()..update(updates)).build();
  ...
  int get hashCode {
    return $jf($jc(
        $jc(
            $jc(
                $jc(
                    $jc($jc(0, sectionOrder.hashCode),
                        splitCompletedSectionByFormat.hashCode),
                    customLists.hashCode),
                advancedScoring.hashCode),
            advancedScoringEnabled.hashCode),
        theme.hashCode));
  }

  @override
  String toString() {
    return (newBuiltValueToStringHelper('GMediaListOptionsInput')
...
class GMediaListOptionsInputBuilder
  ...
  @override
  _$GMediaListOptionsInput build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GMediaListOptionsInput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
class _$GMediaTitleInput extends GMediaTitleInput {
  ...
  factory _$GMediaTitleInput(
      ...
      (new GMediaTitleInputBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GMediaTitleInput')
          ..add('romaji', romaji)
          ..add('english', english)
          ..add('native', native))
        .toString();
...
class _$GNotificationOptionInput extends GNotificationOptionInput {
  ...
  factory _$GNotificationOptionInput(
      ...
      (new GNotificationOptionInputBuilder()..update(updates)).build();
  ...
  @override
  int get hashCode {
    return $jf($jc($jc(0, type.hashCode), enabled.hashCode));
  }

  @override
  String toString() {
    return (newBuiltValueToStringHelper('GNotificationOptionInput')
          ..add('type', type)
          ..add('enabled', enabled))
        .toString();
  }
...
class GNotificationOptionInputBuilder
  ...
  @override
  _$GNotificationOptionInput build() {
    final _$result =
...
class _$GStaffNameInput extends GStaffNameInput {
  ...
  factory _$GStaffNameInput([void Function(GStaffNameInputBuilder)? updates]) =>
      (new GStaffNameInputBuilder()..update(updates)).build();
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc($jc(0, first.hashCode), middle.hashCode), last.hashCode),
            native.hashCode),
        alternative.hashCode));
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GStaffNameInput')
          ..add('first', first)
          ..add('middle', middle)
          ..add('last', last)
          ..add('native', native)
  ...
  _$GStaffNameInput build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GStaffNameInput', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
