...
abstract class GAiringScheduleInput
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GAiringScheduleInput.serializer, this)
          as Map<String, dynamic>);
  static GAiringScheduleInput? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GAiringScheduleInput.serializer, json);
}
...
abstract class GAniChartHighlightInput
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GAniChartHighlightInput.serializer, this)
          as Map<String, dynamic>);
  static GAniChartHighlightInput? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GAniChartHighlightInput.serializer, json);
}
...
abstract class GCharacterNameInput
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GCharacterNameInput.serializer, this)
          as Map<String, dynamic>);
  static GCharacterNameInput? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GCharacterNameInput.serializer, json);
}
...
abstract class GFuzzyDateInput
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GFuzzyDateInput.serializer, this)
          as Map<String, dynamic>);
  static GFuzzyDateInput? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GFuzzyDateInput.serializer, json);
}
...
abstract class GMediaExternalLinkInput
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GMediaExternalLinkInput.serializer, this)
          as Map<String, dynamic>);
  static GMediaExternalLinkInput? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GMediaExternalLinkInput.serializer, json);
}
...
abstract class GMediaListOptionsInput
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GMediaListOptionsInput.serializer, this)
          as Map<String, dynamic>);
  static GMediaListOptionsInput? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GMediaListOptionsInput.serializer, json);
}
...
abstract class GMediaTitleInput
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GMediaTitleInput.serializer, this)
          as Map<String, dynamic>);
  static GMediaTitleInput? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GMediaTitleInput.serializer, json);
}
...
abstract class GNotificationOptionInput
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GNotificationOptionInput.serializer, this)
          as Map<String, dynamic>);
  static GNotificationOptionInput? fromJson(Map<String, dynamic> json) =>
      _i1.serializers
          .deserializeWith(GNotificationOptionInput.serializer, json);
}
...
abstract class GStaffNameInput
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GStaffNameInput.serializer, this)
          as Map<String, dynamic>);
  static GStaffNameInput? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GStaffNameInput.serializer, json);
}
